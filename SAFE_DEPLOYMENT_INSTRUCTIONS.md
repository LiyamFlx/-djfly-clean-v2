...
className =
  'relative group bg-gradient-to-r from-electric-blue via-bright-turquoise to-laser-pink text-white text-xl font-bold px-12 py-6 rounded-2xl shadow-2xl overflow-hidden';
...
const ENABLE_UX_ENHANCEMENTS =
  process.env.VITE_ENABLE_UX_ENHANCEMENTS === 'true';
